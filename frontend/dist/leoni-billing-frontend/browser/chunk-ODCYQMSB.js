...
import {
  MatCardModule
} from "./chunk-LSCX4APG.js";
import {
  MatDivider,
  MatDividerModule
} from "./chunk-FGXHK6GY.js";
import "./chunk-U3DLQZFR.js";
import {
  MatSelect,
  MatSelectModule
...
var SettingsComponent = class _SettingsComponent {
  constructor(fb, auth, theme, profileService, snack) {
    this.fb = fb;
    this.auth = auth;
    this.theme = theme;
  ...
  loadAppearancePrefs() {
    ...
    if (saved) {
      try {
        this.appearance = __spreadValues(__spreadValues({}, this.appearance), JSON.parse(saved));
      } catch {
      }
    }
  }
  ...
  saveAppearance() {
    ...
    this.snack.open("Appearance preferences saved. Reload to apply sidebar changes.", "OK", { duration: 4e3 });
  }
  // ── System ─────────────────────────────────────────────────────────────────
  loadHealth() {
  ...
  static {
    this.\u0275fac = function SettingsComponent_Factory(t) {
      return new (t || _SettingsComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(ThemeService), \u0275\u0275directiveInject(UserProfileService), \u0275\u0275directiveInject(MatSnackBar));
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SettingsComponent, { className: "SettingsComponent", filePath: "src\\app\\features\\settings\\settings.component.ts", lineNumber: 41 });
})();
export {
  SettingsComponent
};
//# sourceMappingURL=chunk-ODCYQMSB.js.map
