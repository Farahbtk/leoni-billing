...
function UserDialogComponent_mat_form_field_15_mat_error_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, "Required");
    \u0275\u0275elementEnd();
...
function UserDialogComponent_mat_form_field_15_mat_error_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
...
function UserDialogComponent_mat_form_field_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-form-field", 8)(1, "mat-label");
    \u0275\u0275text(2, "Email");
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "input", 14);
    \u0275\u0275template(4, UserDialogComponent_mat_form_field_15_mat_error_4_Template, 2, 0, "mat-error", 5)(5, UserDialogComponent_mat_form_field_15_mat_error_5_Template, 2, 0, "mat-error", 5);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngIf", (tmp_1_0 = ctx_r0.form.get("email")) == null ? null : tmp_1_0.hasError("required"));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (tmp_2_0 = ctx_r0.form.get("email")) == null ? null : tmp_2_0.hasError("email"));
  }
}
function UserDialogComponent_mat_form_field_16_mat_error_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, "Required");
    \u0275\u0275elementEnd();
...
function UserDialogComponent_mat_form_field_16_mat_error_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
...
function UserDialogComponent_mat_form_field_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-form-field", 8)(1, "mat-label");
    \u0275\u0275text(2, "Password");
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "input", 15);
    \u0275\u0275template(4, UserDialogComponent_mat_form_field_16_mat_error_4_Template, 2, 0, "mat-error", 5)(5, UserDialogComponent_mat_form_field_16_mat_error_5_Template, 2, 0, "mat-error", 5);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
    ...
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275property("ngIf", (tmp_1_0 = ctx_r0.form.get("password")) == null ? null : tmp_1_0.hasError("required"));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (tmp_2_0 = ctx_r0.form.get("password")) == null ? null : tmp_2_0.hasError("minlength"));
  }
}
function UserDialogComponent_mat_spinner_25_Template(rf, ctx) {
  if (rf & 1) {
...
function UserManagementComponent_div_33_th_3_Template(rf, ctx) {
  if (rf & 1) {
...
function UserManagementComponent_div_33_td_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(u_r3.firstName);
  }
}
function UserManagementComponent_div_33_th_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 39);
    \u0275\u0275text(1, "Last Name");
    \u0275\u0275elementEnd();
...
function UserManagementComponent_div_33_td_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 40);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(u_r4.lastName);
  }
}
function UserManagementComponent_div_33_th_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 39);
    \u0275\u0275text(1, "Email");
    \u0275\u0275elementEnd();
...
function UserManagementComponent_div_33_td_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 40)(1, "span", 41);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function UserManagementComponent_div_33_th_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 39);
    \u0275\u0275text(1, "Department");
    \u0275\u0275elementEnd();
...
function UserManagementComponent_div_33_td_13_span_1_Template(rf, ctx) {
  if (rf & 1) {
...
function UserManagementComponent_div_33_td_13_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
...
function UserManagementComponent_div_33_td_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 40);
    \u0275\u0275template(1, UserManagementComponent_div_33_td_13_span_1_Template, 2, 1, "span", 42)(2, UserManagementComponent_div_33_td_13_ng_template_2_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function UserManagementComponent_div_33_th_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 39);
    \u0275\u0275text(1, "Status");
    \u0275\u0275elementEnd();
...
function UserManagementComponent_div_33_td_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 40)(1, "mat-chip")(2, "mat-icon", 44);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", u_r8.status === "ACTIVE" ? "check_circle" : "cancel", " ");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", u_r8.status, " ");
  }
}
function UserManagementComponent_div_33_th_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 39);
    \u0275\u0275text(1, "Created");
    \u0275\u0275elementEnd();
...
function UserManagementComponent_div_33_td_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 40);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function UserManagementComponent_div_33_th_21_Template(rf, ctx) {
  if (rf & 1) {
...
function UserManagementComponent_div_33_td_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "td", 46)(1, "button", 47);
    \u0275\u0275listener("click", function UserManagementComponent_div_33_td_22_Template_button_click_1_listener() {
    ...
    \u0275\u0275listener("click", function UserManagementComponent_div_33_td_22_Template_button_click_4_listener() {
      const u_r11 = \u0275\u0275restoreView(_r10).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.toggleStatus(u_r11));
    });
    \u0275\u0275elementStart(5, "mat-icon");
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "button", 49);
    \u0275\u0275listener("click", function UserManagementComponent_div_33_td_22_Template_button_click_7_listener() {
      const u_r11 = \u0275\u0275restoreView(_r10).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.deleteManager(u_r11));
    });
...
function UserManagementComponent_div_33_tr_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 50);
  }
}
function UserManagementComponent_div_33_tr_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 51);
  }
}
function UserManagementComponent_div_33_tr_25_span_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
function UserManagementComponent_div_33_tr_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr", 52)(1, "td", 53)(2, "div", 54)(3, "mat-icon");
    \u0275\u0275text(4, "people_outline");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p");
    \u0275\u0275text(6, "No users found");
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, UserManagementComponent_div_33_tr_25_span_7_Template, 2, 0, "span", 55);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275advance(6);
    \u0275\u0275property("ngIf", ctx_r1.searchTerm || ctx_r1.statusFilter);
  }
}
function UserManagementComponent_div_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23)(1, "table", 24);
    \u0275\u0275elementContainerStart(2, 25);
    \u0275\u0275template(3, UserManagementComponent_div_33_th_3_Template, 2, 0, "th", 26)(4, UserManagementComponent_div_33_td_4_Template, 2, 1, "td", 27);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(5, 28);
    \u0275\u0275template(6, UserManagementComponent_div_33_th_6_Template, 2, 0, "th", 26)(7, UserManagementComponent_div_33_td_7_Template, 2, 1, "td", 27);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(8, 29);
    \u0275\u0275template(9, UserManagementComponent_div_33_th_9_Template, 2, 0, "th", 26)(10, UserManagementComponent_div_33_td_10_Template, 3, 1, "td", 27);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(11, 30);
    \u0275\u0275template(12, UserManagementComponent_div_33_th_12_Template, 2, 0, "th", 26)(13, UserManagementComponent_div_33_td_13_Template, 4, 2, "td", 27);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(14, 31);
    \u0275\u0275template(15, UserManagementComponent_div_33_th_15_Template, 2, 0, "th", 26)(16, UserManagementComponent_div_33_td_16_Template, 5, 4, "td", 27);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(17, 32);
    \u0275\u0275template(18, UserManagementComponent_div_33_th_18_Template, 2, 0, "th", 26)(19, UserManagementComponent_div_33_td_19_Template, 3, 4, "td", 27);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(20, 33);
    \u0275\u0275template(21, UserManagementComponent_div_33_th_21_Template, 2, 0, "th", 34)(22, UserManagementComponent_div_33_td_22_Template, 10, 3, "td", 35);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275template(23, UserManagementComponent_div_33_tr_23_Template, 1, 0, "tr", 36)(24, UserManagementComponent_div_33_tr_24_Template, 1, 0, "tr", 37)(25, UserManagementComponent_div_33_tr_25_Template, 8, 2, "tr", 38);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var UserDialogComponent = class _UserDialogComponent {
  constructor(fb, dialogRef, data) {
    ...
    this.form = this.fb.group({
      ...
      email: [
        { value: data.user?.email ?? "", disabled: isEdit },
        isEdit ? [] : [Validators.required, Validators.email]
      ],
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserDialogComponent, selectors: [["app-user-dialog"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 27, vars: 9, consts: [["mat-dialog-title", ""], [1, "dialog-form", 3, "formGroup"], [1, "form-row"], ["appearance", "outline"], ["matInput", "", "formControlName", "firstName", "placeholder", "e.g. Sarah"], [4, "ngIf"], ["matInput", "", "formControlName", "lastName", "placeholder", "e.g. Johnson"], ["appearance", "outline", "class", "full-width", 4, "ngIf"], ["appearance", "outline", 1, "full-width"], ["matInput", "", "formControlName", "department", "placeholder", "e.g. Customer Billing"], ["align", "end"], ["mat-button", "", "mat-dialog-close", ""], ["mat-flat-button", "", "color", "primary", 3, "click", "disabled"], ["diameter", "18", "style", "display:inline-block;margin-right:6px", 4, "ngIf"], ["matInput", "", "formControlName", "email", "type", "email", "placeholder", "user@leoni.com"], ["matInput", "", "formControlName", "password", "type", "password", "placeholder", "Min. 6 characters"], ["diameter", "18", 2, "display", "inline-block", "margin-right", "6px"]], template: function UserDialogComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275template(15, UserDialogComponent_mat_form_field_15_Template, 6, 2, "mat-form-field", 7)(16, UserDialogComponent_mat_form_field_16_Template, 6, 2, "mat-form-field", 7);
        \u0275\u0275elementStart(17, "mat-form-field", 8)(18, "mat-label");
        \u0275\u0275text(19, "Department");
        \u0275\u0275elementEnd();
        \u0275\u0275element(20, "input", 9);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(21, "mat-dialog-actions", 10)(22, "button", 11);
        \u0275\u0275text(23, "Cancel");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(24, "button", 12);
        \u0275\u0275listener("click", function UserDialogComponent_Template_button_click_24_listener() {
          return ctx.submit();
        });
        \u0275\u0275template(25, UserDialogComponent_mat_spinner_25_Template, 1, 0, "mat-spinner", 13);
        \u0275\u0275text(26);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
    ...
    }, dependencies: [CommonModule, NgIf, ReactiveFormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, MatFormFieldModule, MatFormField, MatLabel, MatError, MatInputModule, MatInput, MatButtonModule, MatButton, MatDialogModule, MatDialogClose, MatDialogTitle, MatDialogActions, MatDialogContent, MatProgressSpinnerModule, MatProgressSpinner], styles: ["\n\n.dialog-form[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n  min-width: 420px;\n  padding-top: 8px;\n}\n.form-row[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  gap: 12px;\n}\n.full-width[_ngcontent-%COMP%] {\n  width: 100%;\n}\nmat-dialog-content[_ngcontent-%COMP%] {\n  padding-bottom: 8px;\n}\nmat-dialog-actions[_ngcontent-%COMP%] {\n  padding: 12px 0 0;\n}\n/*# sourceMappingURL=user-management.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserDialogComponent, { className: "UserDialogComponent", filePath: "src\\app\\features\\user-management\\user-management.component.ts", lineNumber: 78 });
})();
var UserManagementComponent = class _UserManagementComponent {
  constructor(adminService, dialog, snack) {
    ...
    this.dialog = dialog;
    this.snack = snack;
    this.displayedColumns = ["firstName", "lastName", "email", "department", "status", "createdAt", "actions"];
    this.allUsers = [];
    this.filteredUsers = [];
    this.loading = true;
    this.searchTerm = "";
  ...
  applyFilter() {
    ...
    this.filteredUsers = this.allUsers.filter((u) => {
      const matchesSearch = !term || u.firstName.toLowerCase().includes(term) || u.lastName.toLowerCase().includes(term) || u.email.toLowerCase().includes(term);
  ...
  openEditDialog(user) {
    ...
    ref.afterClosed().subscribe((result) => {
      if (!result)
        return;
      const payload = { firstName: result.firstName, lastName: result.lastName, department: result.department };
      this.adminService.updateManager(user.id, payload).subscribe({
        next: (updated) => {
          ...
          this.applyFilter();
          this.snack.open("Manager updated", "Close", { duration: 3e3 });
        },
        error: () => this.snack.open("Failed to update manager", "Close", { duration: 4e3 })
      });
    });
  }
  toggleStatus(user) {
  ...
  deleteManager(user) {
    ...
    this.adminService.deleteManager(user.id).subscribe({
      next: () => {
        ...
        this.applyFilter();
        this.snack.open("Manager deleted", "Close", { duration: 3e3 });
      },
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserManagementComponent, selectors: [["app-user-management"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 34, vars: 7, consts: [["noDept", ""], [1, "um-container"], [1, "um-header"], [1, "um-title"], [1, "um-subtitle"], ["mat-flat-button", "", "color", "primary", 3, "click"], [1, "um-toolbar"], ["appearance", "outline", 1, "search-field"], ["matPrefix", ""], ["matInput", "", "placeholder", "Name or email\u2026", 3, "input", "value"], ["matSuffix", "", "mat-icon-button", "", "aria-label", "Clear", 3, "click", 4, "ngIf"], ["appearance", "outline", 1, "status-filter"], [3, "valueChange", "selectionChange", "value"], ["value", ""], ["value", "ACTIVE"], ["value", "INACTIVE"], [1, "spacer"], [1, "result-count"], ["class", "um-loading", 4, "ngIf"], ["class", "um-table-wrapper", 4, "ngIf"], ["matSuffix", "", "mat-icon-button", "", "aria-label", "Clear", 3, "click"], [1, "um-loading"], ["diameter", "48"], [1, "um-table-wrapper"], ["mat-table", "", 1, "um-table", 3, "dataSource"], ["matColumnDef", "firstName"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "lastName"], ["matColumnDef", "email"], ["matColumnDef", "department"], ["matColumnDef", "status"], ["matColumnDef", "createdAt"], ["matColumnDef", "actions"], ["mat-header-cell", "", "class", "actions-header", 4, "matHeaderCellDef"], ["mat-cell", "", "class", "actions-cell", 4, "matCellDef"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", "class", "um-row", 4, "matRowDef", "matRowDefColumns"], ["class", "mat-row", 4, "matNoDataRow"], ["mat-header-cell", ""], ["mat-cell", ""], [1, "email-cell"], [4, "ngIf", "ngIfElse"], [1, "muted"], ["matChipAvatar", ""], ["mat-header-cell", "", 1, "actions-header"], ["mat-cell", "", 1, "actions-cell"], ["mat-icon-button", "", "color", "primary", "matTooltip", "Edit user", "matTooltipPosition", "above", 3, "click"], ["mat-icon-button", "", "matTooltipPosition", "above", 3, "click", "color", "matTooltip"], ["mat-icon-button", "", "color", "warn", "matTooltip", "Delete user", "matTooltipPosition", "above", 3, "click"], ["mat-header-row", ""], ["mat-row", "", 1, "um-row"], [1, "mat-row"], [1, "mat-cell", "empty-cell"], [1, "empty-state"], [4, "ngIf"]], template: function UserManagementComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(31);
        \u0275\u0275elementEnd()();
        \u0275\u0275template(32, UserManagementComponent_div_32_Template, 4, 0, "div", 18)(33, UserManagementComponent_div_33_Template, 26, 3, "div", 19);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(17);
