...
import "./chunk-DNC5WKMM.js";
import {
  MatChipsModule
} from "./chunk-FTTQASBY.js";
import {
  MatSelect,
  MatSelectModule
...
var UserProfileService = class _UserProfileService {
  ...
  changePassword(currentPassword, newPassword) {
    return this.http.put(`${this.base}/change-password`, { currentPassword, newPassword });
  }
  getStats() {
  ...
  downloadCsv(type) {
    this.http.get(`${environment.apiUrl}/${type}/export`, { responseType: "blob" }).subscribe((blob) => {
  ...
  static {
    this.\u0275fac = function UserProfileService_Factory(t) {
      return new (t || _UserProfileService)(\u0275\u0275inject(HttpClient));
    };
  }
  static {
...
function SettingsComponent_div_10_div_11_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2("", ctx_r2.profile.firstName, " ", ctx_r2.profile.lastName, "");
  }
}
function SettingsComponent_div_10_div_12_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r2.profile.role === "ADMIN" ? "Administrator" : "Billing Manager");
  }
}
function SettingsComponent_div_10_mat_error_19_Template(rf, ctx) {
  if (rf & 1) {
...
function SettingsComponent_div_10_mat_error_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, "Required");
    \u0275\u0275elementEnd();
...
function SettingsComponent_div_10_mat_error_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, "Required");
    \u0275\u0275elementEnd();
...
function SettingsComponent_div_10_mat_error_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
...
function SettingsComponent_div_10_mat_option_40_Template(rf, ctx) {
  if (rf & 1) {
...
function SettingsComponent_div_10_mat_spinner_53_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 87);
  }
}
function SettingsComponent_div_10_mat_icon_54_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon");
    \u0275\u0275text(1, "save");
    \u0275\u0275elementEnd();
...
function SettingsComponent_div_10_div_56_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 88)(1, "div", 10)(2, "h2");
    \u0275\u0275text(3, "Account Information");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p");
    \u0275\u0275text(5, "Read-only account details");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 89)(7, "div", 90)(8, "span", 91);
    \u0275\u0275text(9, "Role");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "span", 92)(11, "mat-icon");
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 90)(15, "span", 91);
    \u0275\u0275text(16, "Account Status");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "span", 93);
    \u0275\u0275element(18, "span", 94);
    \u0275\u0275text(19);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "div", 90)(21, "span", 91);
    \u0275\u0275text(22, "Member Since");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "span", 92);
    \u0275\u0275text(24);
    \u0275\u0275pipe(25, "date");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(12);
    \u0275\u0275textInterpolate(ctx_r2.profile.role === "ADMIN" ? "admin_panel_settings" : "manage_accounts");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.profile.role === "ADMIN" ? "Administrator" : "Billing Manager", " ");
    \u0275\u0275advance(4);
    \u0275\u0275classProp("status-active", ctx_r2.profile.status === "ACTIVE");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", ctx_r2.profile.status, " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(25, 6, ctx_r2.profile.createdAt, "dd MMMM yyyy"));
  }
}
function SettingsComponent_div_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p");
    \u0275\u0275text(6, "Update your personal details and contact information");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 68)(8, "div", 69)(9, "div", 70);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275template(11, SettingsComponent_div_10_div_11_Template, 2, 2, "div", 71)(12, SettingsComponent_div_10_div_12_Template, 2, 1, "div", 72);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "form", 73)(14, "div", 74)(15, "mat-form-field", 55)(16, "mat-label");
    \u0275\u0275text(17, "First Name");
    \u0275\u0275elementEnd();
    \u0275\u0275element(18, "input", 75);
    \u0275\u0275template(19, SettingsComponent_div_10_mat_error_19_Template, 2, 0, "mat-error", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "mat-form-field", 55)(21, "mat-label");
    \u0275\u0275text(22, "Last Name");
    \u0275\u0275elementEnd();
    \u0275\u0275element(23, "input", 76);
    \u0275\u0275template(24, SettingsComponent_div_10_mat_error_24_Template, 2, 0, "mat-error", 16);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(29, "email");
    \u0275\u0275elementEnd();
    \u0275\u0275element(30, "input", 77);
    \u0275\u0275template(31, SettingsComponent_div_10_mat_error_31_Template, 2, 0, "mat-error", 16)(32, SettingsComponent_div_10_mat_error_32_Template, 2, 0, "mat-error", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "div", 74)(34, "mat-form-field", 55)(35, "mat-label");
    \u0275\u0275text(36, "Department");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "mat-select", 78)(38, "mat-option", 79);
    \u0275\u0275text(39, "\u2014 None \u2014");
    \u0275\u0275elementEnd();
    \u0275\u0275template(40, SettingsComponent_div_10_mat_option_40_Template, 2, 2, "mat-option", 80);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(41, "mat-form-field", 55)(42, "mat-label");
    \u0275\u0275text(43, "Job Title");
    \u0275\u0275elementEnd();
    \u0275\u0275element(44, "input", 81);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(45, "mat-form-field", 12)(46, "mat-label");
    \u0275\u0275text(47, "Phone Number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "mat-icon", 13);
    \u0275\u0275text(49, "phone");
    \u0275\u0275elementEnd();
    \u0275\u0275element(50, "input", 82);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "div", 19)(52, "button", 20);
    \u0275\u0275listener("click", function SettingsComponent_div_10_Template_button_click_52_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.saveProfile());
    });
    \u0275\u0275template(53, SettingsComponent_div_10_mat_spinner_53_Template, 1, 0, "mat-spinner", 21)(54, SettingsComponent_div_10_mat_icon_54_Template, 2, 0, "mat-icon", 16);
    \u0275\u0275text(55);
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275template(56, SettingsComponent_div_10_div_56_Template, 26, 9, "div", 83);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_6_0;
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.profile);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.profile);
    \u0275\u0275advance();
    \u0275\u0275property("formGroup", ctx_r2.profileForm);
    \u0275\u0275advance(6);
    \u0275\u0275property("ngIf", (tmp_6_0 = ctx_r2.profileForm.get("firstName")) == null ? null : tmp_6_0.hasError("required"));
    \u0275\u0275advance(5);
    \u0275\u0275property("ngIf", (tmp_7_0 = ctx_r2.profileForm.get("lastName")) == null ? null : tmp_7_0.hasError("required"));
    \u0275\u0275advance(7);
    \u0275\u0275property("ngIf", (tmp_8_0 = ctx_r2.profileForm.get("email")) == null ? null : tmp_8_0.hasError("required"));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (tmp_9_0 = ctx_r2.profileForm.get("email")) == null ? null : tmp_9_0.hasError("email"));
    \u0275\u0275advance(8);
    \u0275\u0275property("ngForOf", ctx_r2.departments);
    \u0275\u0275advance(12);
    \u0275\u0275property("disabled", ctx_r2.profileForm.invalid || ctx_r2.savingProfile);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.savingProfile);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r2.savingProfile);
    \u0275\u0275advance();
...
function SettingsComponent_ng_template_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon");
    \u0275\u0275text(1, "lock_outline");
    \u0275\u0275elementEnd();
    \u0275\u0275text(2, "\xA0Security ");
  }
}
function SettingsComponent_mat_error_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, "Required");
    \u0275\u0275elementEnd();
...
function SettingsComponent_mat_error_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, "Required");
    \u0275\u0275elementEnd();
...
function SettingsComponent_mat_error_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
...
function SettingsComponent_mat_error_53_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, "Required");
    \u0275\u0275elementEnd();
...
function SettingsComponent_mat_spinner_57_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 87);
  }
}
function SettingsComponent_div_71_span_7_Template(rf, ctx) {
  if (rf & 1) {
...
function SettingsComponent_div_71_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 97)(1, "div", 98)(2, "mat-icon");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 99)(5, "div", 100);
    \u0275\u0275text(6);
    \u0275\u0275template(7, SettingsComponent_div_71_span_7_Template, 2, 0, "span", 101);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 102)(9, "mat-icon");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275classProp("session-current", s_r5.current);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(s_r5.device.includes("Mobile") ? "phone_android" : "computer");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", s_r5.device, " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", s_r5.current);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", s_r5.location, " \xB7 ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(s_r5.lastActive);
  }
}
function SettingsComponent_ng_template_87_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon");
    \u0275\u0275text(1, "notifications_none");
    \u0275\u0275elementEnd();
    \u0275\u0275text(2, "\xA0Notifications ");
  }
}
function SettingsComponent_div_134_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 36)(1, "div", 32)(2, "mat-icon", 104);
    \u0275\u0275text(3, "person_add");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div")(5, "span", 33);
    \u0275\u0275text(6, "New User Added");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "span", 34);
    \u0275\u0275text(8, "Alert when a new billing manager is created");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(9, "mat-slide-toggle", 38);
    \u0275\u0275twoWayListener("ngModelChange", function SettingsComponent_div_134_Template_mat_slide_toggle_ngModelChange_9_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.notifications.newUserAdded, $event) || (ctx_r2.notifications.newUserAdded = $event);
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classProp("disabled", !ctx_r2.notifications.emailEnabled);
    \u0275\u0275advance(9);
    \u0275\u0275twoWayProperty("ngModel", ctx_r2.notifications.newUserAdded);
    \u0275\u0275property("disabled", !ctx_r2.notifications.emailEnabled);
  }
}
function SettingsComponent_ng_template_151_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon");
    \u0275\u0275text(1, "palette");
    \u0275\u0275elementEnd();
    \u0275\u0275text(2, "\xA0Appearance ");
  }
}
function SettingsComponent_mat_icon_170_Template(rf, ctx) {
  if (rf & 1) {
...
function SettingsComponent_mat_icon_181_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon", 105);
    \u0275\u0275text(1, "check_circle");
    \u0275\u0275elementEnd();
...
function SettingsComponent_mat_icon_192_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon", 105);
    \u0275\u0275text(1, "check_circle");
    \u0275\u0275elementEnd();
...
function SettingsComponent_mat_tab_249_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon");
    \u0275\u0275text(1, "developer_mode");
    \u0275\u0275elementEnd();
    \u0275\u0275text(2, "\xA0System ");
  }
}
function SettingsComponent_mat_tab_249_div_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 111)(1, "div", 112);
    \u0275\u0275element(2, "div", 113);
    \u0275\u0275elementStart(3, "div", 114)(4, "span", 115);
    \u0275\u0275text(5, "Backend API");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "span", 116);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "mat-icon", 117);
    \u0275\u0275text(9, "cloud");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 112);
    \u0275\u0275element(11, "div", 113);
    \u0275\u0275elementStart(12, "div", 114)(13, "span", 115);
    \u0275\u0275text(14, "MySQL Database");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "span", 116);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "mat-icon", 117);
    \u0275\u0275text(18, "storage");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "div", 112);
    \u0275\u0275element(20, "div", 113);
    \u0275\u0275elementStart(21, "div", 114)(22, "span", 115);
    \u0275\u0275text(23, "ML Risk Engine");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "span", 116);
    \u0275\u0275text(25);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(26, "mat-icon", 117);
    \u0275\u0275text(27, "psychology");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 118);
    \u0275\u0275element(29, "div", 119);
    \u0275\u0275elementStart(30, "div", 114)(31, "span", 115);
    \u0275\u0275text(32, "App Version");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "span", 120);
    \u0275\u0275text(34, "1.0.0");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(35, "mat-icon", 117);
    \u0275\u0275text(36, "info");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275classProp("up", ctx_r2.healthStatus.backend === "UP");
    \u0275\u0275advance(4);
    \u0275\u0275classProp("up", ctx_r2.healthStatus.backend === "UP");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.healthStatus.backend, " ");
    \u0275\u0275advance(4);
    \u0275\u0275classProp("up", ctx_r2.healthStatus.database === "UP");
    \u0275\u0275advance(4);
    \u0275\u0275classProp("up", ctx_r2.healthStatus.database === "UP");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.healthStatus.database, " ");
    \u0275\u0275advance(4);
    \u0275\u0275classProp("up", ctx_r2.healthStatus.mlService === "UP");
    \u0275\u0275advance(4);
    \u0275\u0275classProp("up", ctx_r2.healthStatus.mlService === "UP");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.healthStatus.mlService, " ");
  }
}
function SettingsComponent_mat_tab_249_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 121);
    \u0275\u0275element(1, "mat-spinner", 122);
    \u0275\u0275elementEnd();
  }
}
function SettingsComponent_mat_tab_249_div_55_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 9)(1, "div", 10)(2, "h2");
    \u0275\u0275text(3, "User Statistics");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p");
    \u0275\u0275text(5, "Overview of billing manager accounts");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 123)(7, "div", 124)(8, "mat-icon");
    \u0275\u0275text(9, "group");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "span", 125);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "span", 126);
    \u0275\u0275text(13, "Total Managers");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 127)(15, "mat-icon");
    \u0275\u0275text(16, "check_circle");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "span", 125);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "span", 126);
    \u0275\u0275text(20, "Active");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div", 128)(22, "mat-icon");
    \u0275\u0275text(23, "cancel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "span", 125);
    \u0275\u0275text(25);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "span", 126);
    \u0275\u0275text(27, "Inactive");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 129)(29, "mat-icon");
    \u0275\u0275text(30, "login");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "span", 130);
    \u0275\u0275text(32);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "span", 126);
    \u0275\u0275text(34, "Last Activity");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate(ctx_r2.userStats.total);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(ctx_r2.userStats.active);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(ctx_r2.userStats.inactive);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(ctx_r2.userStats.lastLogin);
  }
}
function SettingsComponent_mat_tab_249_ng_template_56_div_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 121);
    \u0275\u0275element(1, "mat-spinner", 122);
    \u0275\u0275elementEnd();
...
function SettingsComponent_mat_tab_249_ng_template_56_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, SettingsComponent_mat_tab_249_ng_template_56_div_0_Template, 2, 0, "div", 131);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275property("ngIf", ctx_r2.loadingStats);
  }
}
function SettingsComponent_mat_tab_249_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-tab");
    \u0275\u0275template(1, SettingsComponent_mat_tab_249_ng_template_1_Template, 3, 0, "ng-template", 6);
    \u0275\u0275elementStart(2, "div", 8)(3, "div", 9)(4, "div", 10)(5, "h2");
    \u0275\u0275text(6, "Application Status");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "p");
    \u0275\u0275text(8, "Real-time health of system services");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(9, SettingsComponent_mat_tab_249_div_9_Template, 37, 15, "div", 106)(10, SettingsComponent_mat_tab_249_ng_template_10_Template, 2, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 9)(13, "div", 10)(14, "h2");
    \u0275\u0275text(15, "Data Management");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "p");
    \u0275\u0275text(17, "Export data or manage system cache");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "div", 107)(19, "div", 108)(20, "mat-icon");
    ...
    \u0275\u0275text(26, "Export all invoices as CSV");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "button", 109);
    \u0275\u0275listener("click", function SettingsComponent_mat_tab_249_Template_button_click_27_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.exportCsv("invoices"));
    });
    ...
    \u0275\u0275text(30, " Export ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(31, "div", 108)(32, "mat-icon");
    \u0275\u0275text(33, "business");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(38, "Export all clients as CSV");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(39, "button", 109);
    \u0275\u0275listener("click", function SettingsComponent_mat_tab_249_Template_button_click_39_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.exportCsv("clients"));
    });
    ...
    \u0275\u0275text(42, " Export ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(43, "div", 108)(44, "mat-icon");
    \u0275\u0275text(45, "cached");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "div")(47, "strong");
    \u0275\u0275text(48, "Cache");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "span");
    \u0275\u0275text(50, "Clear application cache");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(51, "button", 23);
    \u0275\u0275listener("click", function SettingsComponent_mat_tab_249_Template_button_click_51_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.clearCache());
    });
    \u0275\u0275elementStart(52, "mat-icon");
    \u0275\u0275text(53, "delete_sweep");
    \u0275\u0275elementEnd();
    \u0275\u0275text(54, " Clear ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(55, SettingsComponent_mat_tab_249_div_55_Template, 35, 4, "div", 110)(56, SettingsComponent_mat_tab_249_ng_template_56_Template, 1, 1, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const healthLoader_r8 = \u0275\u0275reference(11);
    const statsLoader_r9 = \u0275\u0275reference(57);
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", !ctx_r2.loadingHealth && ctx_r2.healthStatus)("ngIfElse", healthLoader_r8);
    \u0275\u0275advance(46);
    \u0275\u0275property("ngIf", !ctx_r2.loadingStats && ctx_r2.userStats)("ngIfElse", statsLoader_r9);
  }
}
...
var SettingsComponent = class _SettingsComponent {
  constructor(fb, auth, theme, locale, profileService, snack) {
    this.fb = fb;
    this.auth = auth;
    this.theme = theme;
    this.locale = locale;
    ...
    this.departments = ["Customer Billing", "Finance", "Collections", "HR", "Operations"];
    this.fakeSessions = [
  ...
  saveProfile() {
    ...
    this.profileService.updateProfile(this.profileForm.value).subscribe({
      next: (updated) => {
        ...
        this.savingProfile = false;
        this.snack.open("Profile updated successfully", "OK", { duration: 3e3 });
      },
      error: (err) => {
        this.savingProfile = false;
        this.snack.open(err.error?.message ?? "Failed to update profile", "Close", { duration: 4e3 });
      }
    });
  }
  get initials() {
  ...
  changePassword() {
    ...
    this.profileService.changePassword(currentPassword, newPassword).subscribe({
      next: () => {
        ...
        this.snack.open("Password updated successfully", "OK", { duration: 3e3 });
      },
      error: (err) => {
        this.changingPassword = false;
        this.snack.open(err.error?.message ?? "Failed to update password", "Close", { duration: 4e3 });
      }
    });
  }
  logoutOtherSessions() {
    this.snack.open("All other sessions logged out", "OK", { duration: 3e3 });
  }
  // ── Notifications ──────────────────────────────────────────────────────────
  loadNotificationPrefs() {
    ...
    if (saved) {
      try {
        this.notifications = __spreadValues(__spreadValues({}, this.notifications), JSON.parse(saved));
      } catch {
      }
    }
  }
  saveNotifications() {
    ...
    this.snack.open("Notification preferences saved", "OK", { duration: 3e3 });
  }
  // ── Appearance ─────────────────────────────────────────────────────────────
  loadAppearancePrefs() {
    ...
    if (saved) {
      try {
        ...
        this.appearance = __spreadProps(__spreadValues(__spreadValues({}, this.appearance), parsed), {
  ...
  saveAppearance() {
    this.locale.setLang(this.appearance.language);
    this.locale.setCurrency(this.appearance.currency);
  ...
  exportCsv(type) {
    ...
    this.snack.open(`Exporting ${type}\u2026`, "OK", { duration: 2e3 });
  }
  clearCache() {
    this.snack.open("Cache cleared", "OK", { duration: 2e3 });
  }
  static {
    this.\u0275fac = function SettingsComponent_Factory(t) {
      return new (t || _SettingsComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(ThemeService), \u0275\u0275directiveInject(LocaleService), \u0275\u0275directiveInject(UserProfileService), \u0275\u0275directiveInject(MatSnackBar));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SettingsComponent, selectors: [["app-settings"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 250, vars: 51, consts: [["profileLoader", ""], ["healthLoader", ""], ["statsLoader", ""], [1, "settings-container"], [1, "settings-header"], ["animationDuration", "200ms", 1, "settings-tabs"], ["matTabLabel", ""], ["class", "tab-content", 4, "ngIf", "ngIfElse"], [1, "tab-content"], [1, "settings-card"], [1, "card-header"], [1, "password-form", 3, "formGroup"], ["appearance", "outline", 1, "full-width"], ["matPrefix", ""], ["matInput", "", "formControlName", "currentPassword", 3, "type"], ["mat-icon-button", "", "matSuffix", "", "type", "button", 3, "click"], [4, "ngIf"], ["matInput", "", "formControlName", "newPassword", 3, "type"], ["matInput", "", "formControlName", "confirmPassword", 3, "type"], [1, "form-actions"], ["mat-flat-button", "", "color", "primary", 3, "click", "disabled"], ["diameter", "18", "style", "display:inline-block;margin-right:6px", 4, "ngIf"], [1, "card-header-row"], ["mat-stroked-button", "", "color", "warn", 3, "click"], [1, "sessions-list"], ["class", "session-item", 4, "ngFor", "ngForOf"], [1, "coming-soon-badge"], [1, "tfa-row"], ["color", "primary", 3, "disabled"], [1, "tfa-desc"], [1, "toggle-list"], [1, "toggle-item", "toggle-master"], [1, "toggle-info"], [1, "toggle-label"], [1, "toggle-desc"], ["color", "primary", 3, "ngModelChange", "ngModel"], [1, "toggle-item"], [1, "toggle-icon", 2, "color", "#ef4444"], ["color", "primary", 3, "ngModelChange", "ngModel", "disabled"], [1, "toggle-icon", 2, "color", "#f59e0b"], [1, "toggle-icon", 2, "color", "#3b82f6"], ["class", "toggle-item", 3, "disabled", 4, "ngIf"], [1, "toggle-icon", 2, "color", "#6b7280"], ["mat-flat-button", "", "color", "primary", 3, "click"], [1, "theme-options"], [1, "theme-option", 3, "click"], [1, "theme-preview", "theme-light-preview"], [1, "preview-sidebar"], [1, "preview-content"], [1, "preview-bar"], [1, "preview-card"], ["class", "check-icon", 4, "ngIf"], [1, "theme-preview", "theme-dark-preview"], [1, "theme-preview", "theme-system-preview"], [1, "pref-grid"], ["appearance", "outline"], [3, "ngModelChange", "ngModel"], ["value", "en"], ["value", "fr"], ["value", "DD/MM/YYYY"], ["value", "MM/DD/YYYY"], ["value", "YYYY-MM-DD"], ["value", "EUR"], ["value", "USD"], ["value", "GBP"], [1, "toggle-item", 2, "margin-top", "8px"], [1, "toggle-icon"], [1, "form-actions", 2, "margin-top", "20px"], [1, "profile-layout"], [1, "avatar-section"], [1, "profile-avatar"], ["class", "avatar-name", 4, "ngIf"], ["class", "avatar-role", 4, "ngIf"], [1, "profile-form", 3, "formGroup"], [1, "form-row"], ["matInput", "", "formControlName", "firstName"], ["matInput", "", "formControlName", "lastName"], ["matInput", "", "formControlName", "email", "type", "email"], ["formControlName", "department"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["matInput", "", "formControlName", "jobTitle", "placeholder", "e.g. Billing Analyst"], ["matInput", "", "formControlName", "phone", "placeholder", "+216 XX XXX XXX"], ["class", "settings-card info-card", 4, "ngIf"], [1, "avatar-name"], [1, "avatar-role"], [3, "value"], ["diameter", "18", 2, "display", "inline-block", "margin-right", "6px"], [1, "settings-card", "info-card"], [1, "info-grid"], [1, "info-item"], [1, "info-label"], [1, "info-value"], [1, "info-value", "status-badge"], [1, "status-dot"], [1, "tab-loader"], ["diameter", "48"], [1, "session-item"], [1, "session-icon"], [1, "session-info"], [1, "session-device"], ["class", "current-badge", 4, "ngIf"], [1, "session-meta"], [1, "current-badge"], [1, "toggle-icon", 2, "color", "#8b5cf6"], [1, "check-icon"], ["class", "health-grid", 4, "ngIf", "ngIfElse"], [1, "export-grid"], [1, "export-item"], ["mat-stroked-button", "", "color", "primary", 3, "click"], ["class", "settings-card", 4, "ngIf", "ngIfElse"], [1, "health-grid"], [1, "health-item"], [1, "health-dot"], [1, "health-info"], [1, "health-name"], [1, "health-status"], [1, "health-icon"], [1, "health-item", "up-item"], [1, "health-dot", "up"], [1, "health-status", "up"], [1, "tab-loader", "small"], ["diameter", "36"], [1, "stats-grid"], [1, "stat-card"], [1, "stat-value"], [1, "stat-label"], [1, "stat-card", "stat-active"], [1, "stat-card", "stat-inactive"], [1, "stat-card", "stat-login"], [1, "stat-value", "stat-value-sm"], ["class", "tab-loader small", 4, "ngIf"]], template: function SettingsComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "div", 3)(1, "div", 4)(2, "div")(3, "h1");
        \u0275\u0275text(4, "Settings");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(5, "p");
        \u0275\u0275text(6, "Manage your account, security, and preferences");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(7, "mat-tab-group", 5)(8, "mat-tab");
        \u0275\u0275template(9, SettingsComponent_ng_template_9_Template, 3, 0, "ng-template", 6)(10, SettingsComponent_div_10_Template, 57, 14, "div", 7)(11, SettingsComponent_ng_template_11_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(13, "mat-tab");
        \u0275\u0275template(14, SettingsComponent_ng_template_14_Template, 3, 0, "ng-template", 6);
        \u0275\u0275elementStart(15, "div", 8)(16, "div", 9)(17, "div", 10)(18, "h2");
        \u0275\u0275text(19, "Change Password");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(20, "p");
        \u0275\u0275text(21, "Update your password to keep your account secure");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(22, "form", 11)(23, "mat-form-field", 12)(24, "mat-label");
        \u0275\u0275text(25, "Current Password");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275listener("click", function SettingsComponent_Template_button_click_29_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.hideCurrentPw = !ctx.hideCurrentPw);
        });
        \u0275\u0275elementStart(30, "mat-icon");
        \u0275\u0275text(31);
        \u0275\u0275elementEnd()();
        \u0275\u0275template(32, SettingsComponent_mat_error_32_Template, 2, 0, "mat-error", 16);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(33, "mat-form-field", 12)(34, "mat-label");
        \u0275\u0275text(35, "New Password");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275listener("click", function SettingsComponent_Template_button_click_39_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.hideNewPw = !ctx.hideNewPw);
        });
        \u0275\u0275elementStart(40, "mat-icon");
        \u0275\u0275text(41);
        \u0275\u0275elementEnd()();
        \u0275\u0275template(42, SettingsComponent_mat_error_42_Template, 2, 0, "mat-error", 16)(43, SettingsComponent_mat_error_43_Template, 2, 0, "mat-error", 16);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(44, "mat-form-field", 12)(45, "mat-label");
        \u0275\u0275text(46, "Confirm New Password");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(47, "mat-icon", 13);
        \u0275\u0275text(48, "lock_outline");
        \u0275\u0275elementEnd();
        \u0275\u0275element(49, "input", 18);
        \u0275\u0275elementStart(50, "button", 15);
        \u0275\u0275listener("click", function SettingsComponent_Template_button_click_50_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.hideConfirmPw = !ctx.hideConfirmPw);
        });
        \u0275\u0275elementStart(51, "mat-icon");
        \u0275\u0275text(52);
        \u0275\u0275elementEnd()();
        \u0275\u0275template(53, SettingsComponent_mat_error_53_Template, 2, 0, "mat-error", 16)(54, SettingsComponent_mat_error_54_Template, 2, 0, "mat-error", 16);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(55, "div", 19)(56, "button", 20);
        \u0275\u0275listener("click", function SettingsComponent_Template_button_click_56_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.changePassword());
        });
        \u0275\u0275template(57, SettingsComponent_mat_spinner_57_Template, 1, 0, "mat-spinner", 21);
        \u0275\u0275text(58);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(59, "div", 9)(60, "div", 22)(61, "div")(62, "h2");
        \u0275\u0275text(63, "Active Sessions");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(64, "p");
        \u0275\u0275text(65, "Devices currently logged into your account");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(66, "button", 23);
        \u0275\u0275listener("click", function SettingsComponent_Template_button_click_66_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.logoutOtherSessions());
        });
        \u0275\u0275elementStart(67, "mat-icon");
        \u0275\u0275text(68, "logout");
        \u0275\u0275elementEnd();
        \u0275\u0275text(69, " Logout All Others ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(70, "div", 24);
        \u0275\u0275template(71, SettingsComponent_div_71_Template, 15, 7, "div", 25);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(72, "div", 9)(73, "div", 22)(74, "div")(75, "h2");
        \u0275\u0275text(76, "Two-Factor Authentication");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(77, "p");
        \u0275\u0275text(78, "Add an extra layer of security to your account");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(79, "span", 26);
        \u0275\u0275text(80, "Coming Soon");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(81, "div", 27)(82, "mat-slide-toggle", 28);
        \u0275\u0275text(83, "Enable 2FA");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(84, "span", 29);
        \u0275\u0275text(85, "Two-factor authentication is not yet available but will be added in a future update.");
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275elementStart(86, "mat-tab");
        \u0275\u0275template(87, SettingsComponent_ng_template_87_Template, 3, 0, "ng-template", 6);
        \u0275\u0275elementStart(88, "div", 8)(89, "div", 9)(90, "div", 10)(91, "h2");
        \u0275\u0275text(92, "Notification Preferences");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(93, "p");
        \u0275\u0275text(94, "Control which notifications you receive");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(95, "div", 30)(96, "div", 31)(97, "div", 32)(98, "span", 33);
        \u0275\u0275text(99, "Email Notifications");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(100, "span", 34);
        \u0275\u0275text(101, "Master switch for all email notifications");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(102, "mat-slide-toggle", 35);
        \u0275\u0275twoWayListener("ngModelChange", function SettingsComponent_Template_mat_slide_toggle_ngModelChange_102_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.notifications.emailEnabled, $event) || (ctx.notifications.emailEnabled = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275element(103, "mat-divider");
        \u0275\u0275elementStart(104, "div", 36)(105, "div", 32)(106, "mat-icon", 37);
        \u0275\u0275text(107, "warning");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(108, "div")(109, "span", 33);
        \u0275\u0275text(110, "Overdue Invoice Alerts");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(111, "span", 34);
        \u0275\u0275text(112, "Get notified when invoices become overdue");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(113, "mat-slide-toggle", 38);
        \u0275\u0275twoWayListener("ngModelChange", function SettingsComponent_Template_mat_slide_toggle_ngModelChange_113_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.notifications.overdueAlerts, $event) || (ctx.notifications.overdueAlerts = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(114, "div", 36)(115, "div", 32)(116, "mat-icon", 39);
        \u0275\u0275text(117, "psychology");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(118, "div")(119, "span", 33);
        \u0275\u0275text(120, "High Risk Invoice Alerts");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(121, "span", 34);
        \u0275\u0275text(122, "ML risk score above 70% triggers an alert");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(123, "mat-slide-toggle", 38);
        \u0275\u0275twoWayListener("ngModelChange", function SettingsComponent_Template_mat_slide_toggle_ngModelChange_123_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.notifications.highRiskAlerts, $event) || (ctx.notifications.highRiskAlerts = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(124, "div", 36)(125, "div", 32)(126, "mat-icon", 40);
        \u0275\u0275text(127, "bar_chart");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(128, "div")(129, "span", 33);
        \u0275\u0275text(130, "Weekly Summary Report");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(131, "span", 34);
        \u0275\u0275text(132, "Receive a weekly billing performance summary");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(133, "mat-slide-toggle", 38);
        \u0275\u0275twoWayListener("ngModelChange", function SettingsComponent_Template_mat_slide_toggle_ngModelChange_133_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.notifications.weeklySummary, $event) || (ctx.notifications.weeklySummary = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275template(134, SettingsComponent_div_134_Template, 10, 4, "div", 41);
        \u0275\u0275elementStart(135, "div", 36)(136, "div", 32)(137, "mat-icon", 42);
        \u0275\u0275text(138, "build");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(139, "div")(140, "span", 33);
        \u0275\u0275text(141, "System Maintenance Alerts");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(142, "span", 34);
        \u0275\u0275text(143, "Notifications about planned maintenance windows");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(144, "mat-slide-toggle", 38);
        \u0275\u0275twoWayListener("ngModelChange", function SettingsComponent_Template_mat_slide_toggle_ngModelChange_144_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.notifications.maintenanceAlerts, $event) || (ctx.notifications.maintenanceAlerts = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(145, "div", 19)(146, "button", 43);
        \u0275\u0275listener("click", function SettingsComponent_Template_button_click_146_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.saveNotifications());
        });
        \u0275\u0275elementStart(147, "mat-icon");
        \u0275\u0275text(148, "save");
        \u0275\u0275elementEnd();
        \u0275\u0275text(149, " Save Preferences ");
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275elementStart(150, "mat-tab");
        \u0275\u0275template(151, SettingsComponent_ng_template_151_Template, 3, 0, "ng-template", 6);
        \u0275\u0275elementStart(152, "div", 8)(153, "div", 9)(154, "div", 10)(155, "h2");
        \u0275\u0275text(156, "Theme");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(157, "p");
        \u0275\u0275text(158, "Choose how the application looks");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(159, "div", 44)(160, "button", 45);
        \u0275\u0275listener("click", function SettingsComponent_Template_button_click_160_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.setTheme("light"));
        });
        \u0275\u0275elementStart(161, "div", 46);
        \u0275\u0275element(162, "div", 47);
        \u0275\u0275elementStart(163, "div", 48);
        \u0275\u0275element(164, "div", 49)(165, "div", 50);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(166, "mat-icon");
        \u0275\u0275text(167, "light_mode");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(168, "span");
        \u0275\u0275text(169, "Light");
        \u0275\u0275elementEnd();
        \u0275\u0275template(170, SettingsComponent_mat_icon_170_Template, 2, 0, "mat-icon", 51);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(171, "button", 45);
        \u0275\u0275listener("click", function SettingsComponent_Template_button_click_171_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.setTheme("dark"));
        });
        \u0275\u0275elementStart(172, "div", 52);
        \u0275\u0275element(173, "div", 47);
        \u0275\u0275elementStart(174, "div", 48);
        \u0275\u0275element(175, "div", 49)(176, "div", 50);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(177, "mat-icon");
        \u0275\u0275text(178, "dark_mode");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(179, "span");
        \u0275\u0275text(180, "Dark");
        \u0275\u0275elementEnd();
        \u0275\u0275template(181, SettingsComponent_mat_icon_181_Template, 2, 0, "mat-icon", 51);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(182, "button", 45);
        \u0275\u0275listener("click", function SettingsComponent_Template_button_click_182_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.setTheme("system"));
        });
        \u0275\u0275elementStart(183, "div", 53);
        \u0275\u0275element(184, "div", 47);
        \u0275\u0275elementStart(185, "div", 48);
        \u0275\u0275element(186, "div", 49)(187, "div", 50);
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275text(191, "System");
        \u0275\u0275elementEnd();
        \u0275\u0275template(192, SettingsComponent_mat_icon_192_Template, 2, 0, "mat-icon", 51);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(193, "div", 9)(194, "div", 10)(195, "h2");
        \u0275\u0275text(196, "Display Preferences");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(197, "p");
        \u0275\u0275text(198, "Customize regional and layout settings");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(199, "div", 54)(200, "mat-form-field", 55)(201, "mat-label");
        \u0275\u0275text(202, "Language");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(203, "mat-icon", 13);
        \u0275\u0275text(204, "language");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(205, "mat-select", 56);
        \u0275\u0275twoWayListener("ngModelChange", function SettingsComponent_Template_mat_select_ngModelChange_205_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.appearance.language, $event) || (ctx.appearance.language = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275listener("ngModelChange", function SettingsComponent_Template_mat_select_ngModelChange_205_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onLangChange($event));
        });
        \u0275\u0275elementStart(206, "mat-option", 57);
        \u0275\u0275text(207, "English");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(208, "mat-option", 58);
        \u0275\u0275text(209, "Fran\xE7ais");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(210, "mat-form-field", 55)(211, "mat-label");
        \u0275\u0275text(212, "Date Format");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(213, "mat-icon", 13);
        \u0275\u0275text(214, "date_range");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(215, "mat-select", 56);
        \u0275\u0275twoWayListener("ngModelChange", function SettingsComponent_Template_mat_select_ngModelChange_215_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.appearance.dateFormat, $event) || (ctx.appearance.dateFormat = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275elementStart(216, "mat-option", 59);
        \u0275\u0275text(217, "DD/MM/YYYY");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(218, "mat-option", 60);
        \u0275\u0275text(219, "MM/DD/YYYY");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(220, "mat-option", 61);
        \u0275\u0275text(221, "YYYY-MM-DD");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(222, "mat-form-field", 55)(223, "mat-label");
        \u0275\u0275text(224, "Currency Display");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(225, "mat-icon", 13);
        \u0275\u0275text(226, "euro");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(227, "mat-select", 56);
        \u0275\u0275twoWayListener("ngModelChange", function SettingsComponent_Template_mat_select_ngModelChange_227_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.appearance.currency, $event) || (ctx.appearance.currency = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275listener("ngModelChange", function SettingsComponent_Template_mat_select_ngModelChange_227_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onCurrencyChange($event));
        });
        \u0275\u0275elementStart(228, "mat-option", 62);
        \u0275\u0275text(229, "EUR \u2014 Euro (\u20AC)");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(230, "mat-option", 63);
        \u0275\u0275text(231, "USD \u2014 Dollar ($)");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(232, "mat-option", 64);
        \u0275\u0275text(233, "GBP \u2014 Pound (\xA3)");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(234, "div", 65)(235, "div", 32)(236, "mat-icon", 66);
        \u0275\u0275text(237, "view_sidebar");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(238, "div")(239, "span", 33);
        \u0275\u0275text(240, "Compact Sidebar");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(241, "span", 34);
        \u0275\u0275text(242, "Show icons only \u2014 collapse the sidebar by default");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(243, "mat-slide-toggle", 35);
        \u0275\u0275twoWayListener("ngModelChange", function SettingsComponent_Template_mat_slide_toggle_ngModelChange_243_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.appearance.compactSidebar, $event) || (ctx.appearance.compactSidebar = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(244, "div", 67)(245, "button", 43);
        \u0275\u0275listener("click", function SettingsComponent_Template_button_click_245_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.saveAppearance());
        });
        \u0275\u0275elementStart(246, "mat-icon");
        \u0275\u0275text(247, "save");
        \u0275\u0275elementEnd();
        \u0275\u0275text(248, " Save Preferences ");
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275template(249, SettingsComponent_mat_tab_249_Template, 58, 4, "mat-tab", 16);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        let tmp_6_0;
        ...
        let tmp_13_0;
        let tmp_14_0;
        const profileLoader_r10 = \u0275\u0275reference(12);
        \u0275\u0275advance(10);
        \u0275\u0275property("ngIf", !ctx.loadingProfile)("ngIfElse", profileLoader_r10);
        \u0275\u0275advance(12);
        \u0275\u0275property("formGroup", ctx.passwordForm);
        \u0275\u0275advance(6);
        \u0275\u0275property("type", ctx.hideCurrentPw ? "password" : "text");
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(ctx.hideCurrentPw ? "visibility_off" : "visibility");
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", (tmp_6_0 = ctx.passwordForm.get("currentPassword")) == null ? null : tmp_6_0.hasError("required"));
        \u0275\u0275advance(6);
        \u0275\u0275property("type", ctx.hideNewPw ? "password" : "text");
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(ctx.hideNewPw ? "visibility_off" : "visibility");
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", (tmp_9_0 = ctx.passwordForm.get("newPassword")) == null ? null : tmp_9_0.hasError("required"));
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", (tmp_10_0 = ctx.passwordForm.get("newPassword")) == null ? null : tmp_10_0.hasError("minlength"));
        \u0275\u0275advance(6);
        \u0275\u0275property("type", ctx.hideConfirmPw ? "password" : "text");
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(ctx.hideConfirmPw ? "visibility_off" : "visibility");
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", (tmp_13_0 = ctx.passwordForm.get("confirmPassword")) == null ? null : tmp_13_0.hasError("required"));
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.passwordForm.hasError("passwordMismatch") && ((tmp_14_0 = ctx.passwordForm.get("confirmPassword")) == null ? null : tmp_14_0.touched));
        \u0275\u0275advance(2);
        \u0275\u0275property("disabled", ctx.passwordForm.invalid || ctx.changingPassword);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.changingPassword);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" ", ctx.changingPassword ? "Updating\u2026" : "Update Password", " ");
        \u0275\u0275advance(13);
        \u0275\u0275property("ngForOf", ctx.fakeSessions);
        \u0275\u0275advance(11);
        \u0275\u0275property("disabled", true);
        \u0275\u0275advance(20);
        \u0275\u0275twoWayProperty("ngModel", ctx.notifications.emailEnabled);
        \u0275\u0275advance(2);
        \u0275\u0275classProp("disabled", !ctx.notifications.emailEnabled);
        \u0275\u0275advance(9);
        \u0275\u0275twoWayProperty("ngModel", ctx.notifications.overdueAlerts);
        \u0275\u0275property("disabled", !ctx.notifications.emailEnabled);
        \u0275\u0275advance();
        \u0275\u0275classProp("disabled", !ctx.notifications.emailEnabled);
        \u0275\u0275advance(9);
        \u0275\u0275twoWayProperty("ngModel", ctx.notifications.highRiskAlerts);
        \u0275\u0275property("disabled", !ctx.notifications.emailEnabled);
        \u0275\u0275advance();
        \u0275\u0275classProp("disabled", !ctx.notifications.emailEnabled);
        \u0275\u0275advance(9);
        \u0275\u0275twoWayProperty("ngModel", ctx.notifications.weeklySummary);
        \u0275\u0275property("disabled", !ctx.notifications.emailEnabled);
        \u0275\u0275advance();
        ...
        \u0275\u0275classProp("disabled", !ctx.notifications.emailEnabled);
        \u0275\u0275advance(9);
        \u0275\u0275twoWayProperty("ngModel", ctx.notifications.maintenanceAlerts);
        \u0275\u0275property("disabled", !ctx.notifications.emailEnabled);
        \u0275\u0275advance(16);
        \u0275\u0275classProp("active", ctx.theme.mode === "light");
        \u0275\u0275advance(10);
        \u0275\u0275property("ngIf", ctx.theme.mode === "light");
        \u0275\u0275advance();
        \u0275\u0275classProp("active", ctx.theme.mode === "dark");
        \u0275\u0275advance(10);
        \u0275\u0275property("ngIf", ctx.theme.mode === "dark");
        \u0275\u0275advance();
        \u0275\u0275classProp("active", ctx.theme.mode === "system");
        \u0275\u0275advance(10);
        \u0275\u0275property("ngIf", ctx.theme.mode === "system");
        \u0275\u0275advance(13);
        \u0275\u0275twoWayProperty("ngModel", ctx.appearance.language);
        \u0275\u0275advance(10);
        \u0275\u0275twoWayProperty("ngModel", ctx.appearance.dateFormat);
        \u0275\u0275advance(12);
        \u0275\u0275twoWayProperty("ngModel", ctx.appearance.currency);
        \u0275\u0275advance(16);
        \u0275\u0275twoWayProperty("ngModel", ctx.appearance.compactSidebar);
        \u0275\u0275advance(6);
        \u0275\u0275property("ngIf", ctx.isAdmin);
      }
    }, dependencies: [CommonModule, NgForOf, NgIf, DatePipe, ReactiveFormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, FormsModule, NgModel, MatTabsModule, MatTabLabel, MatTab, MatTabGroup, MatCardModule, MatFormFieldModule, MatFormField, MatLabel, MatError, MatPrefix, MatSuffix, MatInputModule, MatInput, MatSelectModule, MatSelect, MatOption, MatButtonModule, MatButton, MatIconButton, MatIconModule, MatIcon, MatSlideToggleModule, MatSlideToggle, MatSnackBarModule, MatProgressSpinnerModule, MatProgressSpinner, MatDividerModule, MatDivider, MatChipsModule, MatTooltipModule], styles: ["\n\n[_nghost-%COMP%] {\n  display: block;\n}\n.settings-container[_ngcontent-%COMP%] {\n  padding: 32px;\n  max-width: 960px;\n  margin: 0 auto;\n}\n.settings-header[_ngcontent-%COMP%] {\n  margin-bottom: 28px;\n}\n.settings-header[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n  margin: 0 0 4px;\n  font-size: 1.75rem;\n  font-weight: 700;\n  color: var(--text-primary);\n}\n.settings-header[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  margin: 0;\n  color: var(--text-secondary);\n  font-size: 0.875rem;\n}\n.settings-tabs[_ngcontent-%COMP%]     .mat-mdc-tab-labels {\n  gap: 4px;\n}\n.settings-tabs[_ngcontent-%COMP%]     .mat-mdc-tab .mdc-tab__content {\n  gap: 6px;\n}\n.tab-content[_ngcontent-%COMP%] {\n  padding: 24px 0;\n  display: flex;\n  flex-direction: column;\n  gap: 20px;\n}\n.tab-loader[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  padding: 80px;\n}\n.tab-loader.small[_ngcontent-%COMP%] {\n  padding: 40px;\n}\n.settings-card[_ngcontent-%COMP%] {\n  background: var(--bg-card);\n  border-radius: 14px;\n  padding: 24px 28px;\n  border: 1px solid var(--border);\n  box-shadow: var(--shadow-card);\n  transition: background 0.3s ease;\n}\n.card-header[_ngcontent-%COMP%] {\n  margin-bottom: 20px;\n}\n.card-header[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%] {\n  margin: 0 0 4px;\n  font-size: 1.05rem;\n  font-weight: 700;\n  color: var(--text-primary);\n}\n.card-header[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  margin: 0;\n  font-size: 0.825rem;\n  color: var(--text-secondary);\n}\n.card-header-row[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: flex-start;\n  justify-content: space-between;\n  margin-bottom: 20px;\n  gap: 16px;\n  flex-wrap: wrap;\n}\n.card-header-row[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%] {\n  margin: 0 0 4px;\n  font-size: 1.05rem;\n  font-weight: 700;\n  color: var(--text-primary);\n}\n.card-header-row[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  margin: 0;\n  font-size: 0.825rem;\n  color: var(--text-secondary);\n}\n.profile-layout[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 32px;\n  align-items: flex-start;\n  flex-wrap: wrap;\n}\n.avatar-section[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 8px;\n  min-width: 120px;\n}\n.avatar-section[_ngcontent-%COMP%]   .avatar-name[_ngcontent-%COMP%] {\n  font-weight: 600;\n  font-size: 0.9rem;\n  color: var(--text-primary);\n  text-align: center;\n}\n.avatar-section[_ngcontent-%COMP%]   .avatar-role[_ngcontent-%COMP%] {\n  font-size: 0.75rem;\n  color: var(--text-secondary);\n  text-align: center;\n}\n.profile-avatar[_ngcontent-%COMP%] {\n  width: 80px;\n  height: 80px;\n  border-radius: 50%;\n  background:\n    linear-gradient(\n      135deg,\n      #1a2e5c,\n      #3d52a0);\n  color: #fff;\n  font-size: 1.5rem;\n  font-weight: 700;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  box-shadow: 0 4px 12px rgba(61, 82, 160, 0.3);\n}\n.profile-form[_ngcontent-%COMP%] {\n  flex: 1;\n  min-width: 300px;\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n}\n.form-row[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  gap: 12px;\n}\n.full-width[_ngcontent-%COMP%] {\n  width: 100%;\n}\n.form-actions[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: flex-end;\n  margin-top: 8px;\n  gap: 12px;\n}\n.info-card[_ngcontent-%COMP%] {\n  background: var(--bg-card);\n}\n.info-grid[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));\n  gap: 16px;\n}\n.info-item[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n}\n.info-item[_ngcontent-%COMP%]   .info-label[_ngcontent-%COMP%] {\n  font-size: 0.72rem;\n  font-weight: 700;\n  text-transform: uppercase;\n  letter-spacing: 0.5px;\n  color: var(--text-secondary);\n}\n.info-item[_ngcontent-%COMP%]   .info-value[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 6px;\n  font-size: 0.9rem;\n  font-weight: 600;\n  color: var(--text-primary);\n}\n.info-item[_ngcontent-%COMP%]   .info-value[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 18px;\n  width: 18px;\n  height: 18px;\n}\n.status-badge[_ngcontent-%COMP%] {\n  display: inline-flex;\n  align-items: center;\n  gap: 6px;\n  padding: 4px 10px;\n  border-radius: 999px;\n  font-size: 0.78rem;\n  font-weight: 700;\n  background: #fee2e2;\n  color: #b91c1c;\n}\n.status-badge.status-active[_ngcontent-%COMP%] {\n  background: #dcfce7;\n  color: #15803d;\n}\n.status-badge[_ngcontent-%COMP%]   .status-dot[_ngcontent-%COMP%] {\n  width: 7px;\n  height: 7px;\n  border-radius: 50%;\n  background: currentColor;\n}\n.password-form[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n  max-width: 480px;\n}\n.sessions-list[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 12px;\n}\n.session-item[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 14px;\n  padding: 12px 16px;\n  border-radius: 10px;\n  background: var(--bg-main);\n  border: 1px solid var(--border);\n}\n.session-icon[_ngcontent-%COMP%] {\n  width: 40px;\n  height: 40px;\n  border-radius: 10px;\n  background: #e2e8f0;\n  color: #64748b;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-shrink: 0;\n}\n.session-icon.session-current[_ngcontent-%COMP%] {\n  background: #dbeafe;\n  color: #1d4ed8;\n}\n.session-icon[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 22px;\n}\n.session-info[_ngcontent-%COMP%] {\n  flex: 1;\n}\n.session-device[_ngcontent-%COMP%] {\n  font-weight: 600;\n  font-size: 0.875rem;\n  color: var(--text-primary);\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n.current-badge[_ngcontent-%COMP%] {\n  background: #dbeafe;\n  color: #1d4ed8;\n  font-size: 0.68rem;\n  font-weight: 700;\n  padding: 1px 7px;\n  border-radius: 999px;\n}\n.session-meta[_ngcontent-%COMP%] {\n  font-size: 0.78rem;\n  color: var(--text-secondary);\n  margin-top: 2px;\n  display: flex;\n  align-items: center;\n  gap: 4px;\n}\n.session-meta[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 13px;\n  width: 13px;\n  height: 13px;\n}\n.coming-soon-badge[_ngcontent-%COMP%] {\n  background: #fef3c7;\n  color: #92400e;\n  font-size: 0.72rem;\n  font-weight: 700;\n  padding: 3px 10px;\n  border-radius: 999px;\n  letter-spacing: 0.3px;\n}\n.tfa-row[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 16px;\n  flex-wrap: wrap;\n  padding: 12px 0;\n}\n.tfa-row[_ngcontent-%COMP%]   .tfa-desc[_ngcontent-%COMP%] {\n  font-size: 0.825rem;\n  color: var(--text-secondary);\n  flex: 1;\n}\n.toggle-list[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 0;\n}\n.toggle-item[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 14px 0;\n  gap: 12px;\n}\n.toggle-item.toggle-master[_ngcontent-%COMP%] {\n  padding-bottom: 16px;\n}\n.toggle-item.disabled[_ngcontent-%COMP%] {\n  opacity: 0.5;\n}\n.toggle-info[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: flex-start;\n  gap: 10px;\n  flex: 1;\n}\n.toggle-info[_ngcontent-%COMP%]   .toggle-icon[_ngcontent-%COMP%] {\n  font-size: 22px;\n  width: 22px;\n  height: 22px;\n  flex-shrink: 0;\n  margin-top: 2px;\n}\n.toggle-label[_ngcontent-%COMP%] {\n  display: block;\n  font-weight: 600;\n  font-size: 0.875rem;\n  color: var(--text-primary);\n}\n.toggle-desc[_ngcontent-%COMP%] {\n  display: block;\n  font-size: 0.78rem;\n  color: var(--text-secondary);\n  margin-top: 2px;\n}\n.theme-options[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 16px;\n  flex-wrap: wrap;\n}\n.theme-option[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 8px;\n  padding: 16px;\n  border-radius: 14px;\n  border: 2px solid var(--border);\n  background: var(--bg-card);\n  cursor: pointer;\n  transition: all 0.2s;\n  min-width: 120px;\n  position: relative;\n  font-family: inherit;\n  font-size: 0.875rem;\n  color: var(--text-primary);\n}\n.theme-option[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 22px;\n  width: 22px;\n  height: 22px;\n  color: var(--text-secondary);\n}\n.theme-option[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  font-weight: 600;\n}\n.theme-option[_ngcontent-%COMP%]:hover {\n  border-color: var(--primary-light);\n  box-shadow: 0 4px 12px rgba(61, 82, 160, 0.15);\n}\n.theme-option.active[_ngcontent-%COMP%] {\n  border-color: var(--primary);\n  background: rgba(61, 82, 160, 0.05);\n}\n.theme-option.active[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  color: var(--primary);\n}\n.theme-option[_ngcontent-%COMP%]   .check-icon[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 8px;\n  right: 8px;\n  font-size: 18px;\n  width: 18px;\n  height: 18px;\n  color: var(--primary);\n}\n.theme-preview[_ngcontent-%COMP%] {\n  width: 80px;\n  height: 52px;\n  border-radius: 8px;\n  overflow: hidden;\n  display: flex;\n  border: 1px solid rgba(0, 0, 0, 0.1);\n}\n.theme-preview[_ngcontent-%COMP%]   .preview-sidebar[_ngcontent-%COMP%] {\n  width: 22px;\n  flex-shrink: 0;\n}\n.theme-preview[_ngcontent-%COMP%]   .preview-content[_ngcontent-%COMP%] {\n  flex: 1;\n  padding: 6px;\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n}\n.theme-preview[_ngcontent-%COMP%]   .preview-bar[_ngcontent-%COMP%] {\n  height: 8px;\n  border-radius: 3px;\n}\n.theme-preview[_ngcontent-%COMP%]   .preview-card[_ngcontent-%COMP%] {\n  flex: 1;\n  border-radius: 3px;\n}\n.theme-light-preview[_ngcontent-%COMP%] {\n  background: #f0f4fc;\n}\n.theme-light-preview[_ngcontent-%COMP%]   .preview-sidebar[_ngcontent-%COMP%] {\n  background: #1e2a4a;\n}\n.theme-light-preview[_ngcontent-%COMP%]   .preview-content[_ngcontent-%COMP%] {\n  background: #f0f4fc;\n}\n.theme-light-preview[_ngcontent-%COMP%]   .preview-bar[_ngcontent-%COMP%] {\n  background: #3d52a0;\n}\n.theme-light-preview[_ngcontent-%COMP%]   .preview-card[_ngcontent-%COMP%] {\n  background: #ffffff;\n}\n.theme-dark-preview[_ngcontent-%COMP%] {\n  background: #121212;\n}\n.theme-dark-preview[_ngcontent-%COMP%]   .preview-sidebar[_ngcontent-%COMP%] {\n  background: #1e2a4a;\n}\n.theme-dark-preview[_ngcontent-%COMP%]   .preview-content[_ngcontent-%COMP%] {\n  background: #121212;\n}\n.theme-dark-preview[_ngcontent-%COMP%]   .preview-bar[_ngcontent-%COMP%] {\n  background: #3d52a0;\n}\n.theme-dark-preview[_ngcontent-%COMP%]   .preview-card[_ngcontent-%COMP%] {\n  background: #1e1e2e;\n}\n.theme-system-preview[_ngcontent-%COMP%] {\n  background:\n    linear-gradient(\n      to right,\n      #f0f4fc 50%,\n      #121212 50%);\n}\n.theme-system-preview[_ngcontent-%COMP%]   .preview-sidebar[_ngcontent-%COMP%] {\n  background: #1e2a4a;\n}\n.theme-system-preview[_ngcontent-%COMP%]   .preview-content[_ngcontent-%COMP%] {\n  background: transparent;\n}\n.theme-system-preview[_ngcontent-%COMP%]   .preview-bar[_ngcontent-%COMP%] {\n  background: #3d52a0;\n}\n.theme-system-preview[_ngcontent-%COMP%]   .preview-card[_ngcontent-%COMP%] {\n  background: rgba(255, 255, 255, 0.3);\n}\n.pref-grid[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(220px, 1fr));\n  gap: 12px;\n}\n.health-grid[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(180px, 1fr));\n  gap: 12px;\n}\n.health-item[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  padding: 14px 16px;\n  border-radius: 10px;\n  background: var(--bg-main);\n  border: 1px solid var(--border);\n}\n.health-dot[_ngcontent-%COMP%] {\n  width: 10px;\n  height: 10px;\n  border-radius: 50%;\n  background: #ef4444;\n  flex-shrink: 0;\n}\n.health-dot.up[_ngcontent-%COMP%] {\n  background: #22c55e;\n  box-shadow: 0 0 6px rgba(34, 197, 94, 0.5);\n}\n.health-info[_ngcontent-%COMP%] {\n  flex: 1;\n}\n.health-name[_ngcontent-%COMP%] {\n  display: block;\n  font-size: 0.8rem;\n  font-weight: 600;\n  color: var(--text-primary);\n}\n.health-status[_ngcontent-%COMP%] {\n  display: block;\n  font-size: 0.72rem;\n  color: #ef4444;\n  font-weight: 700;\n}\n.health-status.up[_ngcontent-%COMP%] {\n  color: #16a34a;\n}\n.health-icon[_ngcontent-%COMP%] {\n  font-size: 22px;\n  width: 22px;\n  height: 22px;\n  color: var(--text-secondary);\n  opacity: 0.5;\n}\n.export-grid[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 12px;\n}\n.export-item[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 14px;\n  padding: 14px 16px;\n  border-radius: 10px;\n  background: var(--bg-main);\n  border: 1px solid var(--border);\n}\n.export-item[_ngcontent-%COMP%]    > mat-icon[_ngcontent-%COMP%] {\n  font-size: 28px;\n  width: 28px;\n  height: 28px;\n  color: var(--primary);\n  flex-shrink: 0;\n}\n.export-item[_ngcontent-%COMP%]    > div[_ngcontent-%COMP%] {\n  flex: 1;\n}\n.export-item[_ngcontent-%COMP%]    > div[_ngcontent-%COMP%]   strong[_ngcontent-%COMP%] {\n  display: block;\n  font-size: 0.875rem;\n  color: var(--text-primary);\n}\n.export-item[_ngcontent-%COMP%]    > div[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  font-size: 0.78rem;\n  color: var(--text-secondary);\n}\n.stats-grid[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(160px, 1fr));\n  gap: 14px;\n}\n.stat-card[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 6px;\n  padding: 20px 16px;\n  border-radius: 12px;\n  text-align: center;\n  background: #f0f4fc;\n  border: 1px solid var(--border);\n}\n.stat-card[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 32px;\n  width: 32px;\n  height: 32px;\n  color: var(--primary);\n}\n.stat-card.stat-active[_ngcontent-%COMP%] {\n  background: #f0fdf4;\n}\n.stat-card.stat-active[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  color: #16a34a;\n}\n.stat-card.stat-inactive[_ngcontent-%COMP%] {\n  background: #fef2f2;\n}\n.stat-card.stat-inactive[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  color: #dc2626;\n}\n.stat-card.stat-login[_ngcontent-%COMP%] {\n  background: #eff6ff;\n}\n.stat-card.stat-login[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  color: #2563eb;\n}\n.stat-value[_ngcontent-%COMP%] {\n  font-size: 1.75rem;\n  font-weight: 800;\n  color: var(--text-primary);\n  line-height: 1;\n}\n.stat-value-sm[_ngcontent-%COMP%] {\n  font-size: 0.875rem;\n  font-weight: 700;\n}\n.stat-label[_ngcontent-%COMP%] {\n  font-size: 0.72rem;\n  font-weight: 600;\n  color: var(--text-secondary);\n  text-transform: uppercase;\n  letter-spacing: 0.5px;\n}\n/*# sourceMappingURL=settings.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SettingsComponent, { className: "SettingsComponent", filePath: "src\\app\\features\\settings\\settings.component.ts", lineNumber: 42 });
})();
export {
  SettingsComponent
};
//# sourceMappingURL=chunk-HK66DQTQ.js.map
